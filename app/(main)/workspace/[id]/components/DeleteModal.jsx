    ...
    <>
      {isModalOpen && (
        <div className="fixed top-0 left-0 h-full w-full z-[100] bg-black/40 flex items-center justify-center">
          <div className="p-5 bg-white rounded-lg shadow-lg dark:bg-gray-700 dark:border dark:border-gray-400 w-96">
            ...
            <div className="flex justify-end mt-4 space-x-3">
              <button
                ...
                className="px-4 py-2 rounded cursor-pointer dark:border dark:hover:bg-gray-800 dark:bg-gray-700 hover:bg-gray-200"
              >
                Cancel
              </button>
              <button
